Rails.autoloaders.each do |autoloader|
  ...
  autoloader.inflector.inflect(
    ...
    "dclp" => "DCLP",
    "apis" => "APIS",
    "ddb_current_identifier" => "DDBCurrentIdentifier",
    "ddb_current_identifiers_controller" => "DDBCurrentIdentifiersController",
    ...
    "dclp_current_meta_identifier" => "DCLPCurrentMetaIdentifier",
    "dclp_current_meta_identifiers_controller" => "DCLPCurrentMetaIdentifiersController",
    "dclp_current_text_identifier" => "DCLPCurrentTextIdentifier",
    "dclp_current_text_identifiers_controller" => "DCLPCurrentTextIdentifiersController",
