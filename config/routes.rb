ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :publications do |publication|
    ...
    publication.resources :eagle_trans_cts_identifiers, :member => { :history => :get,  :preview => :get, :editxml => :get, :updatexml => :put, :rename_review => :get, :rename => :put, :create => :post, :link_citation => :get, :annotate_xslt => :get}
