ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :publications do |publication|
    ...
    publication.resources :epi_trans_cts_identifiers, :member => { :history => :get,  :preview => :get, :editxml => :get, :updatexml => :put, :rename_review => :get, :rename => :put, :create => :post, :link_citation => :get, :annotate_xslt => :get}
    ...
    publication.resources :oa_cite_identifiers, :member => { :create => :post, :history => :get, :preview => :get, :annotate_xslt => :get, :editxml => :get, :updatexml => :put, :exportxml => :get, :edit_or_create => :post, :append => :post, :delete_annotation => :post }
