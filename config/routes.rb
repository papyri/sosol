ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :publications do |publication|
    ...
    publication.resources :epi_trans_cts_identifiers, :member => { :history => :get,  :preview => :get, :editxml => :get, :edittext => :get, :updatetext => :put, :updatexml => :put, :rename_review => :get, :rename => :put, :create => :post, :link_citation => :get, :annotate_xslt => :get}
