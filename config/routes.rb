ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :publications, :member => {  :edit_adjacent => :get, :edit_text => :get, :edit_meta => :get, :edit_biblio => :get, :edit_trans => :get, :show => :get, :create => :post, :create_from_templates => :post, :create_from_selector => :post, :submit => :post, :remit => :post, :finalize_review => :get, :finalize => :post, :become_finalizer => :post }
