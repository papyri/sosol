ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :publications do |publication|
    ...
    publication.resources :treebank_cite_identifiers, :member => { :create => :post, :history => :get, :preview => :get, :editxml => :get, :updatexml => :put, :exportxml => :get, :edit => :post, :rename_review => :get, :rename => :put, :api_get => :get, :api_update => :post, :edit_title => :get, :update_title => :put, :review => :get}
