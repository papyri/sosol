ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :publications, :member => { :edit_text => :get, :edit_meta => :get, :edit_trans => :get, :show => :get, :create => :post, :create_from_templates => :post, :submit_review => :get, :submit => :post, :finalize => :get }
