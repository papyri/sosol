...
* Java SE 6 (1.6+)
* JRuby (1.7.4+) - tested through JRuby 1.7.4. Preferably managed through {rbenv}[https://github.com/sstephenson/rbenv].
* Bundler (1.3.5+) (gem install bundler)
* Git (1.6.1.3+)
