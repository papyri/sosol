...
* Java SE 8 (1.8+)
* JRuby (1.7.26) - Preferably managed through {rbenv}[https://github.com/sstephenson/rbenv]. Must be run in Ruby 2.0 compatibility mode (pass JRUBY_OPTS="--2.0" or use {rbenv-vars}[https://github.com/rbenv/rbenv-vars] to load this from the included .rbenv-vars file).
* Bundler (1.15.1+) (gem install bundler)
* Git (1.7.1+)
