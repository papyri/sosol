...
function multiAdd(id)
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + value + '" name="apis_identifier[' + id + '][' + index + ']" id="apis_identifier_' + id + '_' + index + '" class="observechange">' +
...
function multiAddTextarea(id)
{
  ...
  var item = '<li>' +
             '  <textarea name="apis_identifier[' + id + '][' + index + ']" id="apis_identifier_' + id + '_' + index + '" class="observechange">' + value +'</textarea>' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddGenre()
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + value + '" name="apis_identifier[genre][' + index + '][children][rs][value]" id="apis_identifier_genre_' + index + '" class="observechange">' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddCitedLiterature(){
  ...
  var item = '<li>' +
             '  <input class="observechange target" id="apis_identifier_citedLiterature_'  + index + '_children_pointer_attributes_target" name="apis_identifier[citedLiterature]['  + index + '][children][pointer][attributes][target]" value="'  + target + '" type="text">' +
             '  <input class="observechange pagination" id="apis_identifier_citedLiterature_'  + index + '_children_pagination_value" name="apis_identifier[citedLiterature]['  + index + '][children][pagination][value]" value="'  + pagination + '" type="text">' +
...
function multiAddBl()
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + volume + '" name="apis_identifier[bl][' + index + '][children][volume][value]" id="apis_identifier_bl_' + index + '_children_volume_value" class="observechange volume">' +
             '  <input type="text" value="' + page + '" name="apis_identifier[bl][' + index + '][children][page][value]" id="apis_identifier_bl_' + index + '_children_page_value" class="observechange page">' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddProvenanceRaw(e){
  ...
  var item = '<li id="provenance_' + provenanceIndex + '" class="provenance">' +
             '   <p class="clear"></p>' +
             '   <label class="meta provenanceType" for="apis_identifier_provenance_' + provenanceIndex + '_attributes_type" title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/provenance">Type</label>' +
             '   <select class="observechange provenanceType" id="apis_identifier_provenance_' + provenanceIndex + '_attributes_type" name="apis_identifier[provenance][' + provenanceIndex + '][attributes][type]"><option value=""></option>' +
             '   <option value=""></option>' +
             ...
             '   <label class="meta provenanceSubtype" for="apis_identifier_provenance_' + provenanceIndex + '_attributes_subtype" title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/provenance">Subtype</label>' +
             '   <select class="observechange provenanceSubtype" id="apis_identifier_provenance_' + provenanceIndex + '_attributes_subtype" name="apis_identifier[provenance][' + provenanceIndex + '][attributes][subtype]"><option value=""></option>' +
             '   <option value="last">last</option></select>' +
             '   <label class="meta provenanceDate" for="apis_identifier_provenance_' + provenanceIndex + '_attributes_date" title="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/history/provenance">Date</label>' +
             '   <input class="observechange provenanceDate" id="apis_identifier_provenance_' + provenanceIndex + '_attributes_date" name="apis_identifier[provenance][' + provenanceIndex + '][attributes][date]" value="" type="text">' +
...
function multiAddPlaceRaw(e){
  ...
  var item = '<li>' +
             '   <input type="hidden" value="" name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][attributes][id]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_attributes_id" class="observechange provenancePlaceId">' +
             '   <input type="hidden" value="" name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][attributes][exclude]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_attributes_exclude" class="observechange provenancePlaceExclude">' +
...
function multiAddGeoSpot(key, provenanceIndex, placeIndex)
{
  ...
  var item = '<li>' +
             '  <select name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][type]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_type" class="observechange provenanceGeoType"><option value="ancient"' + (type == 'ancient' ? ' selected="selected"' : '') + '>ancient</option>' +
             '  <option value="modern"' + (type == 'modern' ? ' selected="selected"' : '') + '>modern</option></select>' +
             '  <select name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][subtype]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_subtype" class="observechange provenanceGeoSubtype"><option value=""></option>' +
             ...
             '  <select name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][children][geo][' + geoIndex + '][children][offset][value]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_children_offset_value" class="observechange provenanceGeoOffset"><option value=""></option>' +
             '  <option value="bei"' + (offset == 'bei' ? ' selected="selected"' : '') + '>near</option></select>' +
             '  <input type="text" value="' + name + '" name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][children][geo][' + geoIndex + '][value]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_value" class="observechange provenanceGeoName">' +
             '  <input type="checkbox" value="low" name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][certainty]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_certainty" class="observechange provenanceGeoCertainty"' + (uncertainty ? ' checked="checked"' : '') + '>' +
             '  <label for="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_certainty" class="geoSpotUncertain">uncertain</label>' +
             '  <span title="Click to delete item" onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span title="Click and drag to move item" class="move">o</span>' +
             '  <div class="paragraph geoReferenceContainer"' + ($('toggleReferenceList').hasClassName('showReferenceList') ? ' style="display: none;"' : '') + '>' +
             '    <input type="text" value="' + referenceString + '" name="apis_identifier[provenance][' + provenanceIndex + '][children][place][' + placeIndex + '][children][geo][' + geoIndex + '][attributes][reference]" id="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_reference" class="observechange provenanceGeoReference">' +
             '    <label for="apis_identifier_provenance_' + provenanceIndex + '_children_place_' + placeIndex + '_children_geo_' + geoIndex + '_attributes_reference">Reference</label>' +
  ...
  for(i = 0; i < referenceList.length; i++){
    ...
    item +=  '        <li>' +
             '          <input type="text" value="' + referenceList[i] + '" name="apis_identifier[' + referenceKey + '][' + i + ']" id="apis_identifier_' + referenceKey + '_' + i + '" class="observechange">' +
             '          <span title="Click to delete item" onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '          <span title="Click and drag to move item" class="move">o</span>' +
             '        </li>';
  }
...
function multiAddPublicationExtra()
{
  ...
  var item = '<li>' +
             '  <input class="observechange publicationExtra" id="apis_identifier_publicationExtra_' + index + '_value" name="apis_identifier[publicationExtra][' + index + '][value]" type="text" value="' + value + '" />' + 
             '  <input class="observechange publicationExtra" id="apis_identifier_publicationExtra_' + index + '_attributes_type" name="apis_identifier[publicationExtra][' + index + '][attributes][type]" type="hidden" value="' + type + '" />' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddFigures()
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + url + '" name="apis_identifier[figures][' + index + '][children][graphic][attributes][url]" id="apis_identifier_figures_' + index + '_children_graphic_attributes_url" class="observechange">' +
             '  <span onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span class="move">o</span>' +
             '</li>';
...
function multiAddMentionedDate()
{
  ...
  var item = '<li>' +
             '  <input type="text" value="' + reference +  '" name="apis_identifier[mentionedDate][' + index +  '][children][ref][value]" id="apis_identifier_mentionedDate_' + index +  '_children_ref_value" class="observechange reference">' +
             '  <input type="text" value="' + comment +  '" name="apis_identifier[mentionedDate][' + index +  '][children][comment][value]" id="apis_identifier_mentionedDate_' + index +  '_children_comment_value" class="observechange comment">' +
             '  <input type="text" value="' + date1 +  '" onchange="mentionedDateNewDate(this)" name="apis_identifier[mentionedDate][' + index +  '][date1]" id="apis_identifier_mentionedDate_' + index +  '_date1" class="observechange">' +
             '  <input type="text" value="' + date2 +  '" onchange="mentionedDateNewDate(this)" name="apis_identifier[mentionedDate][' + index +  '][date2]" id="apis_identifier_mentionedDate_' + index +  '_date2" class="observechange">' +
             '  <input type="hidden" value="" name="apis_identifier[mentionedDate][' + index +  '][children][date][attributes][when]" id="apis_identifier_mentionedDate_' + index +  '_children_date_attributes_when">' +
             '  <input type="hidden" value="" name="apis_identifier[mentionedDate][' + index +  '][children][date][attributes][notBefore]" id="apis_identifier_mentionedDate_' + index +  '_children_date_attributes_notBefore">' +
             '  <input type="hidden" value="" name="apis_identifier[mentionedDate][' + index +  '][children][date][attributes][notAfter]" id="apis_identifier_mentionedDate_' + index +  '_children_date_attributes_notAfter">' +
             '  <input type="text" value="' + annotation +  '" name="apis_identifier[mentionedDate][' + index +  '][children][annotation][value]" id="apis_identifier_mentionedDate_' + index +  '_children_annotation_value" class="observechange annotation">' +
             '  <select onchange="mentionedDateNewCertainty(this)" name="apis_identifier[mentionedDate][' + index +  '][certaintyPicker]" id="apis_identifier_mentionedDate_' + index +  '_certaintyPicker" class="observechange certainty"><option value=""></option>' +
             ...
             '  <select name="apis_identifier[mentionedDate][' + index +  '][children][date][children][certainty][0][attributes][relation]" id="apis_identifier_mentionedDate_' + index +  '_children_date_children_certainty_0_attributes_relation" class="observechange dateId"><option value=""></option>' +
             ...
             '  <input type="hidden" value="1" name="apis_identifier[mentionedDate][' + index +  '][children][date][children][certainty][0][attributes][degree]" id="apis_identifier_mentionedDate_' + index +  '_children_date_children_certainty_0_attributes_degree">' +
             '  <span title="Click to delete item" onclick="multiRemove(this.parentNode)" class="delete">x</span>' +
             '  <span title="Click and drag to move item" class="move">o</span>' +
             '</li>';
  ...
  mentionedDateNewDate($('apis_identifier_mentionedDate_' + index +  '_date1'));
}
...
function mentionedDateNewCertainty(selectbox)
{
  ...
  if (value.length) {
    if (value == 'low') { // global    
      $(selectbox).parentNode.insert('<input type="hidden" value="low" name="apis_identifier[mentionedDate][' + index + '][children][date][attributes][certainty]" id="apis_identifier_mentionedDate_' + index + '_children_date_attributes_certainty">');
    }
    else { // specific
      ...
      for (i = 0; i < dateBits.length; i++) {
        ...
        for (j = 0; j < dateTypes.length; j++) {
          ...
          $(selectbox).parentNode.insert('<input type="hidden" value="../date/' + dateBits[i] + '-from-date(@' + dateType + ')" name="apis_identifier[mentionedDate][' + index + '][children][date][children][certainty][' + certaintyIndex + '][attributes][match]" id="apis_identifier_mentionedDate_' + index + '_children_date_children_certainty_' + certaintyIndex + '_attributes_match">');
          certaintyIndex++;
        }
      }
    }
...
Event.observe(window, 'load', function() {
  ...
  $$('.quickSave').each(function(e){e.observe('click', function(e){checkNotAddedMultiples(); rememberToggledView(); set_conf_false(); $$('form.edit_apis_identifier')[0].submit();});});
