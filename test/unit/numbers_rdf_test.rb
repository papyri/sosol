...
class NumbersRDFTest < ActiveSupport::TestCase
  ...
  should "respond to an identifier request with the correct related identifiers" do
    ...
    assert_equal ["papyri.info/ddbdp/p.nyu;1;1", "papyri.info/apis/nyu.apis.4782","papyri.info/hgv/12481", "papyri.info/trismegistos/12481", "www.trismegistos.org/text/12481", "papyri.info/apis/nyu.apis.4782/images"], response
  end
