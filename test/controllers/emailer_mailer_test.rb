...
class EmailerMailerTest < ActionMailer::TestCase
  ...
  define_method "test_: identifier_email with simple message no parsing no comments" do
  ...
  define_method "test_: identifier_email with simple message no parsing with comments" do
  ...
  define_method "test_: identifier_email with full parsing no comments" do
  ...
  define_method "test_: identifier_email with simple message custom subject no parsing no comments" do
  ...
  define_method "test_: identifier_email with simple message custom parsed subject no parsing no comments" do
