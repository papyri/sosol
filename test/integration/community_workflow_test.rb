  ...
  context 'for community' do
    context 'community testing' do
      ...
      teardown do
        ...
        begin
          count = 0
          [@board_user, @board_user_2, @creator_user, @end_user, @community_user, @trash_user,
           @test_community].each do |entity|
            count += 1
      ...
      should 'user creates and submits publication to community' do
        ...
        assert_nil end_publication,
                   '--Community end user has a publication before they should (after meta has been finalized)'
        ...
        open_session do |text_rename_session|
          text_rename_session.patch "/publications/#{text_final_publication.id}/ddb_identifiers/#{text_final_identifier.id}/rename/",
                                    params: { test_user_id: @board_user.id.to_s, new_name: 'papyri.info/ddbdp/bgu;1;987',
                                              set_dummy_header: false }
        end
