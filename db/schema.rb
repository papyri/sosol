...
ActiveRecord::Schema[6.1].define(version: 20_211_004_142_258) do
  ...
  create_table 'boards_users', id: false, force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[board_id user_id], name: 'index_boards_users_on_board_id_and_user_id', unique: true
  end
  ...
  create_table 'emailers_users', id: false, force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[emailer_id user_id], name: 'index_emailers_users_on_emailer_id_and_user_id', unique: true
  end
