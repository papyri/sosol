...
ActiveRecord::Schema.define(:version => 20110811204557) do
  ...
  create_table "boards", :force => true do |t|
    t.string   "title"
    t.string   "category"
    t.integer  "decree_id",          :limit => 0
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "finalizer_user_id",  :limit => 0
    t.text     "identifier_classes"
    t.decimal  "rank"
    t.string   "friendly_name"
    t.integer  "community_id",       :limit => 0
  end

  create_table "boards_users", :id => false, :force => true do |t|
    t.integer  "board_id",   :limit => 0
  ...
  create_table "comments", :force => true do |t|
    t.text     "comment"
    t.integer  "user_id",        :limit => 0
    t.integer  "identifier_id",  :limit => 0
    t.string   "reason"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "git_hash"
    t.integer  "publication_id", :limit => 0
  end

  create_table "communities", :force => true do |t|
    t.string   "name"
    t.string   "friendly_name"
    t.integer  "members",        :limit => 0
    t.integer  "admins",         :limit => 0
    t.string   "description"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "board_id",       :limit => 0
    t.integer  "publication_id", :limit => 0
    t.integer  "end_user_id",    :limit => 0
  end
  ...
  create_table "events", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "owner_id",    :limit => 0
    t.string   "owner_type"
    t.integer  "target_id",   :limit => 0
  ...
  create_table "publications", :force => true do |t|
    ...
    t.string   "branch"
    t.string   "status",                    :default => "editing"
    t.integer  "creator_id",   :limit => 0
    t.string   "creator_type"
    t.integer  "parent_id",    :limit => 0
    t.integer  "community_id", :limit => 0
  end
