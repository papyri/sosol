    ...
    def prune_params
      if params[:hgv_meta_identifier]
        params[:hgv_meta_identifier]['textDate'].each_pair{|index, date|
          ...
          date['children'] = {} #todocl: remove this line when date tags are allowed within origDate
          if date['value'].empty? #todocl: remove this line because this value will be generated by the system and not edited by the user

          ['onDate', 'fromDate', 'toDate'].each {|dateType|
            if date['children'][dateType]
              date['children'][dateType]['children'].delete 'offset' #todocl: remove this line when offset is allowed within EpiDoc
      ...
      if params[:hgv_meta_identifier]
        params[:hgv_meta_identifier]['textDate'].each{|index, date|
          ...
          tasks.each_pair{|chron, value|
            if date['attributes'][{:chron => 'textDateWhen', :chronMin => 'textDateFrom', :chronMax => 'textDateTo'}[chron]].empty? #todocl: remove this line because these values should always be generated by the system
