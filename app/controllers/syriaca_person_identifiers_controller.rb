class SyriacaPersonIdentifiersController < IdentifiersController
  #layout 'site'
  ...
  def editxml
    ...
    @is_editor_view = true
    render :template => 'syriaca_person_identifiers/editxml'
  end
  ...
  protected
    ...
    def find_identifier
      @identifier = SyriacaPersonIdentifier.find(params[:id].to_s)
    end
