...
class Community < ApplicationRecord
  ...
  validates_format_of :name, :without => Repository::BASH_SPECIAL_CHARACTERS_REGEX, :message => "Name cannot contain any of the following special characters: #{Repository::BASH_SPECIAL_CHARACTERS_REGEX.source[1..-2]}"
