...
class DDBCurrentIdentifier < DDBIdentifier
  PATH_PREFIX = 'DDbDP'.freeze

  FRIENDLY_NAME = 'Current DDbDP Text'.freeze

  IDENTIFIER_NAMESPACE = 'current'.freeze
  ...
  def to_path
    ...
    # assume the name is e.g. current/2302a
  ...
  def dummy_header(options = {})
    # No-op for current DDbDP identifiers
  end
